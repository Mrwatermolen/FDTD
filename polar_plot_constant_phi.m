function polar_plot_constant_phi(phi, pattern_1, pattern_2, ...
...
text(1.02 * 1.1, 0.13 * 1.1, '¼', 'fontname', 'tex', ...
    'color', 'b', 'fontweight', 'demi');
